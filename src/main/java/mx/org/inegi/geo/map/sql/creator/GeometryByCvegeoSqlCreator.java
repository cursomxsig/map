 ...
 *
 */
public class GeometryByCvegeoSqlCreator implements SqlCreator {

	private static final Logger logger = Logger
			.getLogger(GeometryByCvegeoSqlCreator.class);

	private Table table;
	private String cvegeo;

	public GeometryByCvegeoSqlCreator(Table table, String cvegeo) {
		this.table = table;
		this.cvegeo = cvegeo;
	}
